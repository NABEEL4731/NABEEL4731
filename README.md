...
[![GitHub Stars](https://img.shields.io/github/stars/NABEEL4731?style=for-the-badge&color=yellow)](https://github.com/NABEEL4731)
...
Specialization:
  ...
  - Widget-driven development & custom UI
  - REST API integration & secure authentication
  - Payment & chat SDK integrations
...
> *"Results-driven Flutter Developer delivering high-performance, cross-platform apps with measurable impact."*
...
- 🔥 Leveraged **Firebase** FCM, Crashlytics, Analytics, and Remote Config for monitoring and A/B testing
...
- 📦 Delivered offline-first storage with **Hive**, bookmark system, and translation history
- ⚡ Reduced design-to-development time by **14%** with a reusable Material 3 component library
- 🔄 Used **GetX** for lightweight, scalable state management and reactive UI updates
...
<table>
  ...
  <tr>
    <td width="50%">
      ...
      <p>IoT automation app providing real-time control over air purifiers with device grouping, scheduling, dark/light themes, and error-resilient offline handling.</p>
      <p>
        <img src="https://img.shields.io/badge/Flutter-02569B?style=flat&logo=flutter&logoColor=white"/>
        <img src="https://img.shields.io/badge/Tuya_SDK-FF6600?style=flat"/>
        <img src="https://img.shields.io/badge/Firebase-FFCA28?style=flat&logo=firebase&logoColor=black"/>
...
### 🧠 State Management
![Bloc](https://img.shields.io/badge/Bloc-7B61FF?style=for-the-badge)
...
![Riverpod](https://img.shields.io/badge/Riverpod-00BCD4?style=for-the-badge)
...
![Crashlytics](https://img.shields.io/badge/Crashlytics-FF5722?style=for-the-badge&logo=firebase&logoColor=white)
![Remote Config](https://img.shields.io/badge/Remote_Config-F57C00?style=for-the-badge&logo=firebase&logoColor=white)
...
| Metric | Achievement |
|--------|-------------|
| ⚡ API Latency Reduction | **15%** improvement via caching & request batching |
| 🚀 IoT Command Speed | **16%** boost via local state caching & MQTT optimization |
| 📈 User Retention Increase | **15%** uplift through polished UX & Material 3 design |
| 🏗️ Dev Time Reduction | **12–14%** via reusable widget libraries & modular architecture |
...
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](https://mail.google.com/mail/?view=cm&fs=1&to=nabeeledu.786@gmail.com)
...
|----------|---------------|-----------|
| User-centered design | Optimized API handling | Clean, maintainable code |
| Scalable architecture | Fast, smooth UI | Comprehensive testing |
| Clean Architecture patterns | Efficient state management | Security-first approach |
| IoT & real-time systems | Low-latency integrations | Pixel-perfect UI/UX |
...
**Open to new Flutter opportunities — let's build something great together! 🚀**

*Available for: Flutter Developer roles, freelance mobile projects, and open-source collaboration.*
